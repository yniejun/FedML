...
if __name__ == '__main__':
    ...
    os.mkdir('../../../fedml_mobile/server/executor/preprocessed_dataset/MNIST/MNIST_mobile_zip')
    for worker in client_list:
        ...
        shutil.make_archive('MNIST_mobile/{}'.format(worker.client_id), 'zip',
                            '../../../fedml_mobile/server/executor/preprocessed_dataset/MNIST/MNIST_mobile', str(worker.client_id))
        shutil.move('MNIST_mobile/{}.zip'.format(worker.client_id),
                    '../../../fedml_mobile/server/executor/preprocessed_dataset/MNIST/MNIST_mobile_zip')